...
#
# #########training 2nd task################
train_task(model,800,20,mnist2,[mnist,mnist2],x,y_,'2',lams=[0,3])
...
model.star()
train_task(model,800,20,mnist3,[mnist,mnist2,mnist3],x,y_,'3',lams=[0,3])
model.compute_fisher(mnist3.validation.images, sess, num_samples=200, plot_diffs=False)

p = []
for v in range(len(model.var_list)):
    p.append(model.var_list[v].eval())
joblib.dump(p,'f')

mnist4 = permute_mnist((mnist))
model.star()
train_task(model,800,20,mnist4,[mnist,mnist2,mnist3,mnist4],x,y_,'4',lams=[0,3])
...
model.star()
train_task(model,800,20,mnist5,[mnist,mnist2,mnist3,mnist4,mnist5],x,y_,'5',lams=[0,3])
...
model.star()
train_task(model,800,20,mnist6,[mnist,mnist2,mnist3,mnist4,mnist5,mnist6],x,y_,'6',lams=[0,3])
...
model.star()
train_task(model,800,20,mnist7,[mnist,mnist2,mnist3,mnist4,mnist5,mnist6,mnist7],x,y_,'7',lams=[0,3])
...
model.star()
train_task(model,800,20,mnist8,[mnist,mnist2,mnist3,mnist4,mnist5,mnist6,mnist7,mnist8],x,y_,'8',lams=[0,3])
model.compute_fisher(mnist8.validation.images, sess, num_samples=200, plot_diffs=False)

mnist9 = permute_mnist((mnist))
model.star()
train_task(model,800,20,mnist9,[mnist,mnist2,mnist3,mnist4,mnist5,mnist6,mnist7,mnist8,mnist9],x,y_,'9',lams=[0,3])
model.compute_fisher(mnist9.validation.images, sess, num_samples=200, plot_diffs=False)
#
